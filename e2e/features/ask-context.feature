Feature: Ask Context
  Scenario: The first Ask in a Primary turn includes current visible text
    ...
    And the latest Ask Context should include Primary tool intent for "SECRET_TOOL_PATH"
  ...
  Scenario: Ask Context includes currently visible Primary Agent work
    ...
    And the latest Ask Context should include Primary tool intent for "SECRET_STREAMING_TOOL"
